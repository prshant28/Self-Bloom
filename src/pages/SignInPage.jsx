                    ...
                    <div className="w-full max-w-md" style={{ zIndex: 10 }}>
                        ...
                        >
                            <div className="text-center mb-8">
                                <h1 className="text-3xl font-display text-white mt-4">Welcome Back</h1>
                                <p className="text-muted-foreground">Sign in to continue your growth.</p>
                            </div>
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input id="password" type="password" placeholder="••••••••" required className="pl-10 bg-black/30 border-white/10 focus:border-primary focus:ring-primary" value={password} onChange={(e) => setPassword(e.target.value)} />
                                    </div>
                                </div>
